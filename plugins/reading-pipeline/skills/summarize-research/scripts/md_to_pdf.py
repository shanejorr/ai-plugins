#!/usr/bin/env python3
"""
Convert a Markdown file to PDF with the reading-pipeline formatting standard.
...
Standard (applies to every PDF this plugin produces):
  ...
  - Heading scale matches the EPUB stylesheet for visual consistency
...
def render_with_pandoc(md_path: str, output_path: str) -> bool:
    if not shutil.which("pandoc"):
        return False
    # Pandoc needs a CSS file on disk
